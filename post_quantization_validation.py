...
from timm.data import Dataset, DatasetTar, resolve_data_config, RealLabelsImagenet
from timm.data.quant_loader import create_loader
            ...
            if batch_idx % args.log_freq == 0:
                _logger.info(
                    ...
                    'Acc@5: {top5.val:>7.3f} ({top5.avg:>7.3f})'.format(
                        batch_idx, args.calib_iter, batch_time=batch_time,
