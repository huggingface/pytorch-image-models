...
class EfficientNet(nn.Module):
    ...
    def fuse_model(self):
        modules_to_fuse = [['conv_stem','bn1'], ['conv_head','bn2']]
...
@register_model
def quant_mnasnet_050(pretrained=False, **kwargs):
...
@register_model
def quant_mnasnet_075(pretrained=False, **kwargs):
...
@register_model
def quant_mnasnet_100(pretrained=False, **kwargs):
...
@register_model
def quant_mnasnet_b1(pretrained=False, **kwargs):
    """ MNASNet B1, depth multiplier of 1.0. """
    return mnasnet_100(pretrained, **kwargs)


@register_model
def quant_mnasnet_140(pretrained=False, **kwargs):
...
@register_model
def quant_semnasnet_050(pretrained=False, **kwargs):
...
@register_model
def quant_semnasnet_075(pretrained=False, **kwargs):
...
@register_model
def quant_semnasnet_100(pretrained=False, **kwargs):
...
@register_model
def quant_mnasnet_a1(pretrained=False, **kwargs):
    """ MNASNet A1 (w/ SE), depth multiplier of 1.0. """
    return semnasnet_100(pretrained, **kwargs)


@register_model
def quant_semnasnet_140(pretrained=False, **kwargs):
...
@register_model
def quant_mnasnet_small(pretrained=False, **kwargs):
...
@register_model
def quant_mobilenetv2_100(pretrained=False, **kwargs):
...
@register_model
def quant_mobilenetv2_140(pretrained=False, **kwargs):
...
@register_model
def quant_mobilenetv2_110d(pretrained=False, **kwargs):
...
@register_model
def quant_mobilenetv2_120d(pretrained=False, **kwargs):
...
@register_model
def quant_fbnetc_100(pretrained=False, **kwargs):
    """ FBNet-C """
    if pretrained:
...
@register_model
def quant_spnasnet_100(pretrained=False, **kwargs):
    """ Single-Path NAS Pixel1"""
...
@register_model
def quant_efficientnet_b0(pretrained=False, **kwargs):
    """ EfficientNet-B0 """
...
@register_model
def quant_efficientnet_b1(pretrained=False, **kwargs):
    """ EfficientNet-B1 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    model = _gen_efficientnet(
...
@register_model
def quant_efficientnet_b2(pretrained=False, **kwargs):
    """ EfficientNet-B2 """
...
@register_model
def quant_efficientnet_b2a(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_b3(pretrained=False, **kwargs):
    """ EfficientNet-B3 """
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    model = _gen_efficientnet(
...
@register_model
def quant_efficientnet_b3a(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_b4(pretrained=False, **kwargs):
    """ EfficientNet-B4 """
...
@register_model
def quant_efficientnet_b5(pretrained=False, **kwargs):
    """ EfficientNet-B5 """
    # NOTE for train, drop_rate should be 0.4, drop_path_rate should be 0.2
    model = _gen_efficientnet(
...
@register_model
def quant_efficientnet_b6(pretrained=False, **kwargs):
    """ EfficientNet-B6 """
...
@register_model
def quant_efficientnet_b7(pretrained=False, **kwargs):
    """ EfficientNet-B7 """
    # NOTE for train, drop_rate should be 0.5, drop_path_rate should be 0.2
    model = _gen_efficientnet(
...
@register_model
def quant_efficientnet_b8(pretrained=False, **kwargs):
    """ EfficientNet-B8 """
    # NOTE for train, drop_rate should be 0.5, drop_path_rate should be 0.2
    model = _gen_efficientnet(
...
@register_model
def quant_efficientnet_l2(pretrained=False, **kwargs):
    """ EfficientNet-L2."""
    # NOTE for train, drop_rate should be 0.5, drop_path_rate should be 0.2
    model = _gen_efficientnet(
...
@register_model
def quant_efficientnet_es(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_em(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_el(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_cc_b0_4e(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_cc_b0_8e(pretrained=False, **kwargs):
    """ EfficientNet-CondConv-B0 w/ 8 Experts """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    model = _gen_efficientnet_condconv(
...
@register_model
def quant_efficientnet_cc_b1_8e(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_lite0(pretrained=False, **kwargs):
    """ EfficientNet-Lite0 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
...
@register_model
def quant_efficientnet_lite1(pretrained=False, **kwargs):
    """ EfficientNet-Lite1 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    model = _gen_efficientnet_lite(
...
@register_model
def quant_efficientnet_lite2(pretrained=False, **kwargs):
    """ EfficientNet-Lite2 """
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    model = _gen_efficientnet_lite(
...
@register_model
def quant_efficientnet_lite3(pretrained=False, **kwargs):
    """ EfficientNet-Lite3 """
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    model = _gen_efficientnet_lite(
...
@register_model
def quant_efficientnet_lite4(pretrained=False, **kwargs):
    """ EfficientNet-Lite4 """
    # NOTE for train, drop_rate should be 0.4, drop_path_rate should be 0.2
    model = _gen_efficientnet_lite(
...
@register_model
def quant_efficientnet_b1_pruned(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_b2_pruned(pretrained=False, **kwargs):
...
@register_model
def quant_efficientnet_b3_pruned(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b0(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b1(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b2(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b3(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b4(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b5(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b6(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b7(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b8(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b0_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b1_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b2_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b3_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b4_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b5_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b6_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b7_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b8_ap(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b0_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b1_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b2_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b3_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b4_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b5_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b6_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_b7_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_l2_ns_475(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_l2_ns(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_es(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_em(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_el(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_cc_b0_4e(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_cc_b0_8e(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_cc_b1_8e(pretrained=False, **kwargs):
...
@register_model
def quant_tf_efficientnet_lite0(pretrained=False, **kwargs):
    """ EfficientNet-Lite0 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
...
@register_model
def quant_tf_efficientnet_lite1(pretrained=False, **kwargs):
    """ EfficientNet-Lite1 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
...
@register_model
def quant_tf_efficientnet_lite2(pretrained=False, **kwargs):
    """ EfficientNet-Lite2 """
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
...
@register_model
def quant_tf_efficientnet_lite3(pretrained=False, **kwargs):
    """ EfficientNet-Lite3 """
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
...
@register_model
def quant_tf_efficientnet_lite4(pretrained=False, **kwargs):
    """ EfficientNet-Lite4 """
    # NOTE for train, drop_rate should be 0.4, drop_path_rate should be 0.2
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
...
@register_model
def quant_mixnet_s(pretrained=False, **kwargs):
    """Creates a MixNet Small model.
    """
    model = _gen_mixnet_s(
...
@register_model
def quant_mixnet_m(pretrained=False, **kwargs):
...
@register_model
def quant_mixnet_l(pretrained=False, **kwargs):
...
@register_model
def quant_mixnet_xl(pretrained=False, **kwargs):
...
@register_model
def quant_mixnet_xxl(pretrained=False, **kwargs):
...
@register_model
def quant_tf_mixnet_s(pretrained=False, **kwargs):
...
@register_model
def quant_tf_mixnet_m(pretrained=False, **kwargs):
...
@register_model
def quant_tf_mixnet_l(pretrained=False, **kwargs):
