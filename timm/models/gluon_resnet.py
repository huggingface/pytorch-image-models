...
url_dir_path = 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/'
default_cfgs = {
    'gluon_resnet18_v1b': _cfg(url=url_dir_path + 'gluon_resnet18_v1b-0757602b.pth'),
    'gluon_resnet34_v1b': _cfg(url=url_dir_path + 'gluon_resnet34_v1b-c6d82d59.pth'),
    'gluon_resnet50_v1b': _cfg(url=url_dir_path + 'gluon_resnet50_v1b-0ebe02e2.pth'),
    'gluon_resnet101_v1b': _cfg(url=url_dir_path + 'gluon_resnet101_v1b-3b017079.pth'),
    'gluon_resnet152_v1b': _cfg(url=url_dir_path + 'gluon_resnet152_v1b-c1edb0dd.pth'),
    'gluon_resnet50_v1c': _cfg(url=url_dir_path + 'gluon_resnet50_v1c-48092f55.pth'),
    'gluon_resnet101_v1c': _cfg(url=url_dir_path + 'gluon_resnet101_v1c-1f26822a.pth'),
    'gluon_resnet152_v1c': _cfg(url=url_dir_path + 'gluon_resnet152_v1c-a3bb0b98.pth'),
    'gluon_resnet50_v1d': _cfg(url=url_dir_path + 'gluon_resnet50_v1d-818a1b1b.pth'),
    'gluon_resnet101_v1d': _cfg(url=url_dir_path + 'gluon_resnet101_v1d-0f9c8644.pth'),
    'gluon_resnet152_v1d': _cfg(url=url_dir_path + 'gluon_resnet152_v1d-bd354e12.pth'),
    'gluon_resnet50_v1e': _cfg(),
    'gluon_resnet101_v1e': _cfg(),
    'gluon_resnet152_v1e': _cfg(),
    'gluon_resnet50_v1s': _cfg(url=url_dir_path + 'gluon_resnet50_v1s-1762acc0.pth'),
    'gluon_resnet101_v1s': _cfg(url=url_dir_path + 'gluon_resnet101_v1s-60fe0cc1.pth'),
    'gluon_resnet152_v1s': _cfg(url=url_dir_path + 'gluon_resnet152_v1s-dcc41b81.pth'),
    'gluon_resnext50_32x4d': _cfg(url=url_dir_path + 'gluon_resnext50_32x4d-e6a097c1.pth'),
    'gluon_resnext101_32x4d': _cfg(url=url_dir_path + 'gluon_resnext101_32x4d-b253c8c4.pth'),
    'gluon_resnext101_64x4d': _cfg(url=url_dir_path + 'gluon_resnext101_64x4d-f9a8e184.pth'),
    'gluon_seresnext50_32x4d': _cfg(url=url_dir_path + 'gluon_seresnext50_32x4d-90cf2d6e.pth'),
    'gluon_seresnext101_32x4d': _cfg(url=url_dir_path + 'gluon_seresnext101_32x4d-cf52900d.pth'),
    'gluon_seresnext101_64x4d': _cfg(url=url_dir_path + 'gluon_seresnext101_64x4d-f9926f93.pth'),
    'gluon_senet154': _cfg(url=url_dir_path + 'gluon_senet154-70a1a3c0.pth'),
}
