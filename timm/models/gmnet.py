...
Code: https://github.com/YFWang1999/GmNet
Paper: https://arxiv.org/abs/2503.22841
...
from timm.layers import DropPath, SelectAdaptivePool2d, Linear, trunc_normal_, calculate_drop_path_rates
...
def _cfg(url: str = '', **kwargs: Any) -> Dict[str, Any]:
    return {
        ...
        'paper_ids': 'arXiv:2503.22841',
        'paper_name': 'GmNet: Revisiting Gating Mechanisms From A Frequency View',
        'origin_url': 'https://github.com/YFWang1999/GmNet', 'license': 'apache-2.0',
        **kwargs
    }


default_cfgs = generate_default_cfgs({
    'gmnet_s1.untrained': _cfg(),
    'gmnet_s2.untrained': _cfg(),
    'gmnet_s3.untrained': _cfg(),
    'gmnet_s4.untrained': _cfg(),
})


def _create_gmnet(variant: str, pretrained: bool = False, **kwargs: Any) -> GmNet:
    model = build_model_with_cfg(
        GmNet, variant, pretrained,
...
@register_model
def gmnet_s1(pretrained: bool = False, **kwargs: Any) -> GmNet:
    model_args = dict(base_dim=40, depths=[2, 2, 10, 2], mlp_ratio=[3, 3, 3, 2])
    return _create_gmnet('gmnet_s1', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def gmnet_s2(pretrained: bool = False, **kwargs: Any) -> GmNet:
    model_args = dict(base_dim=48, depths=[2, 2, 8, 3], mlp_ratio=[3, 3, 3, 2])
    return _create_gmnet('gmnet_s2', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def gmnet_s3(pretrained: bool = False, **kwargs: Any) -> GmNet:
    model_args = dict(base_dim=48, depths=[3, 3, 8, 3], mlp_ratio=[4, 4, 4, 4])
    return _create_gmnet('gmnet_s3', pretrained=pretrained, **dict(model_args, **kwargs))


@register_model
def gmnet_s4(pretrained: bool = False, **kwargs: Any) -> GmNet:
    model_args = dict(base_dim=68, depths=[3, 3, 11, 3], mlp_ratio=[4, 4, 4, 4])
    return _create_gmnet('gmnet_s4', pretrained=pretrained, **dict(model_args, **kwargs))